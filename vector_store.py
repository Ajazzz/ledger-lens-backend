...
class LedgerLensIndexer:
    def __init__(self, data_dir: str = "structured_data"):
        ...
        # 1. Setup Local Embeddings (Fast & Free)
        # BGE-Small is industry standard for retrieval accuracy
    ...
    def run_indexing(self):
        ...
        # Only load our top30 Markdown file
        documents = SimpleDirectoryReader(input_dir=str(self.data_dir)).load_data()

        # 3. ARCHITECT'S CHOICE: MarkdownNodeParser
        # This respects # Headers and ## Subheaders for better context
